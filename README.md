...
response mode
short guidance
Includes a Streamlit interface for single-comment analysis
Compares:
...
Dataset source: ReAct (public peer-review comment dataset)
...
This turns raw reviewer comments into more usable author-side decision support.
